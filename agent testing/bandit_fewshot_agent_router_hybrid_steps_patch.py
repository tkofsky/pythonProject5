...
# - Router decides one-pass vs two-pass per input using simple features
# - Bandit optimizes (prompt_id x few-shot k x temperature)
# - Two-pass extracts structured fields first, then generates anchored steps
# - N-best candidate selection for steps + normalization + anchor gating + generic blocker
# - Intent-specific style hints to reduce lexical variance
#
# Usage:
...
CSV_LOG      = "bandit_fewshot_agent_log_router_hybrid_steps_patch.csv"
