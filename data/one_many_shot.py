...
def run_experiment(iterations=10):
    with open(CSV_LOG, "w", newline="", encoding="utf-8") as csvfile:
        ...
        writer.writerow(["iteration", "example_count", "prompt_text", "input", "reference", "model_output", "reward", "category"])
        ...
        for i in range(iterations):
            for example_count in [0, 1, 3, 5]:
                ...
                writer.writerow([i+1, example_count, prompt, sample["input"], sample["reference"], output, reward, "few-shot"])
